...
Here is the initial state of the board <img src="/images/Move-Brute-Force/ex0">
We swipe left to move the top and bottom dots one space to the left and
producing this board <img src="/images/Move-Brute-Force/ex1"> Next we swipe
down moving only one dot down <img src="/images/Move-Brute-Force/ex2"> Finally
we swipe left to align all dots with shaded square <img
src="/images/Move-Brute-Force/ex3">
